               ...
               <li class="layui-nav-item  layui-nav-itemed">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" href-url="user/uxinxi0.jsp"><i class="layui-icon">&#xe621;</i>个人工资</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe627;</i>商品信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="user/shangpin.jsp"><i class="layui-icon">&#xe621;</i>添加商品</a></dd>
                        <dd><a href="javascript:;" href-url="user/shangpinedate1.jsp"><i class="layui-icon">&#xe621;</i>过期商品</a></dd>
                        <dd><a href="javascript:;" href-url="user/shangpinyujing.jsp"><i class="layui-icon">&#xe621;</i>库存预警</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe628;</i>进货信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="user/spjin.jsp"><i class="layui-icon">&#xe621;</i>进货信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe629;</i>销售信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="user/spchu.jsp"><i class="layui-icon">&#xe621;</i>销售信息</a></dd>
                    </dl>
                </li>
            </ul>
