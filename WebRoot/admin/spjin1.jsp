...
var url;
	...
	function shenheSpjin(){
		var selectedRows=$("#dg").datagrid('getSelections');
		if(selectedRows.length!=1){
			$.messager.alert("系统提示","请选择一条要校验的数据！");
			return;
		}
		var row=selectedRows[0];
		url="../addSpjin?spjinId="+row.spjinId;
		$.messager.confirm("系统提示","您确认要校验吗？",function(r){
			if(r){
...
<!--startprint-->
	<table id="dg" title="采购信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSpjins?spjinType=1" fit="true" toolbar="#tb">
		<thead>
			<tr>
