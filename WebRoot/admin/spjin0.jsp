<%@ page language="java" import="com.model.Spjin"  pageEncoding="utf-8"%>
...
var url;
	...
	function shenheSpjin(){
		var selectedRows=$("#dg").datagrid('getSelections');
		if(selectedRows.length!=1){
			$.messager.alert("系统提示","请选择一条要入库的数据！");
			return;
		}
		var row=selectedRows[0];
		url="../addSpjin?spjinId="+row.spjinId;
		$.messager.confirm("系统提示","您确认要入库吗？",function(r){
			if(r){
...
<!--startprint-->
	<table id="dg" title="采购信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSpjins?spjinType=0" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="spcangkuId" width="20" hidden="true">仓库ID</th>
				<th field="spcangkuName" width="40">仓库</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:shenheSpjin()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">入库</a>
		</div>
		<div>
		...
		&nbsp;仓库：&nbsp;<input class="easyui-combobox" id="s_spcangkuId" name="s_spcangkuId"  data-options="panelHeight:'auto',editable:false,valueField:'spcangkuId',textField:'spcangkuName',url:'../spcangkuComboList'"/>
		...
		&nbsp;员工：&nbsp;<input class="easyui-combobox" id="s_userId" name="s_userId"  data-options="panelHeight:'auto',editable:false,valueField:'userId',textField:'userName',url:'../userComboList'"/>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px;height: 280px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td>类型2：</td>
					<td><select class="easyui-combobox" id="spjinType" name="spjinType" editable="false" panelHeight="auto" style="width: 155px">
				...
				<tr>
					<td valign="top">缘由：</td>
					<td><textarea rows="7" cols="30" name="spjinMark3" id="spjinMark3"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
