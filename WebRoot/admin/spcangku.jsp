<%@ page language="java" import="com.model.Spcangku"  pageEncoding="utf-8"%>
...
var url;
	...
	function daoruSpcangkus(){
		$("#daoru").dialog("open").dialog("setTitle","导入仓库信息");
	...
	function shangchuanSpcangku(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传仓库信息");
	 ...
	 pagination="true" url="../getSpcangkus" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="spcangkuName" width="40">名称</th>
				<th field="spcangkuMark" width="40">备注</th>
				<th field="spcangkuPhone" width="40">电话</th>
				<th field="spcangkuDizhi" width="40">地址</th>
			</tr>
		</thead>
	</table>
	...
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 160px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>电话：</td>
					<td><input type="text" name="spcangkuPhone" id="spcangkuPhone" class="easyui-validatebox" required="true"/></td>
					<td>地址：</td>
					<td><input type="text" name="spcangkuDizhi" id="spcangkuDizhi" class="easyui-validatebox" required="true"/></td>
				</tr>
			</table>
		</form>
	</div>
