<%@ page language="java" import="com.model.Shangpin"  pageEncoding="utf-8"%>
...
var url;
	...
	function openShangpinAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加库存预警");
		url="../addShangpin";
	}
	...
	function openShangpinModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑库存预警");
		$("#fm").form("load",row);
	...
	function daoruShangpins(){
		$("#daoru").dialog("open").dialog("setTitle","导入库存预警");
	...
	function shangchuanShangpin(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传库存预警");
...
<!--startprint-->
	<table id="dg" title="库存预警" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getShangpins?shangpinType1=0" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="shangpinId" width="20">编号</th>
				<th field="shangpinName" width="40">名称</th>
				<th field="shangpinMark1" width="40">用途</th>
				<th field="shangpinZong" width="20">总数</th>
				<th field="shangpinJin" width="20">进货总价</th>
				<th field="sptypeId" width="20" hidden="true">类型ID</th>
				<th field="sptypeName" width="40">类型</th>
				<th field="shangpinDate" width="40" formatter="datetostr">时间</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb" hidden="true">
		...
		&nbsp;类型：&nbsp;<input class="easyui-combobox" id="s_sptypeId" name="s_sptypeId"  data-options="panelHeight:'auto',editable:false,valueField:'sptypeId',textField:'sptypeName',url:'../sptypeComboList'"/>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px;height: 280px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td>类型2：</td>
					<td><select class="easyui-combobox" id="shangpinType" name="shangpinType" editable="false" panelHeight="auto" style="width: 155px">
				...
				<tr>
					<td valign="top">缘由：</td>
					<td><textarea rows="7" cols="30" name="shangpinMark3" id="shangpinMark3"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
