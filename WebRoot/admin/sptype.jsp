<%@ page language="java" import="com.model.Sptype"  pageEncoding="utf-8"%>
...
<script type="text/javascript">
	...
	function openSptypeModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑商品类型");
		$("#fm").form("load",row);
...
<body style="margin: 5px;">
	<table id="dg" title="商品类型" class="easyui-datagrid" fitColumns="true"
