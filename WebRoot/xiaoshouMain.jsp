            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
               <li class="layui-nav-item  layui-nav-itemed">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="user/shangpin.jsp"><i class="layui-icon">&#xe621;</i>商品信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon">&#xe629;</i>销售信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="user/spchu0.jsp"><i class="layui-icon">&#xe621;</i>销售信息</a></dd>
                    </dl>
                </li>
            </ul>
