...
var userId = <%=userId%>;
	...
	function openShangpinModifyDialog(){
		...
		$("#fm").form("load",row);
		url="../addSpjin?shangpinId="+row.shangpinId+"&userId="+userId;
	}
...
<!--startprint-->
	 ...
	 pagination="true" url="../getShangpins?shangpinType1=0" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="shangpinJin" width="20">总进</th>
	...
	<div id="tb" hidden="true">
		<div>
			<a href="javascript:openShangpinModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">采购</a>
		</div>
		<div>
